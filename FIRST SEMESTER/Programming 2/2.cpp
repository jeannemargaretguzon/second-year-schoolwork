...
/* Write a program that will initally create an SORTED list containing the following and then run the program:
    Diane
    Jack
    Katherine
    Mitch
